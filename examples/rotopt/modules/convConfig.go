...
func GetConvBlueprints(convID string, depth int) ([][]int, int, []int) {
	...
	} else if convID == "CvTConv1" { //8*8*64 -> 4*4*192, kernel=3*3 (192->256), k=1
		//CvTConv1
		//=================Choose MAP=================//
		if depth == 2 {
			/*rot num:  146
			...
			blueprints = [][]int{ //optimal
				{5},
				{2, 24, 64, 128, 256, 512, 1024},
				{3, 16, 2048,
					4096 - 1, 4096 - 1 + 2048,
					4096*2 - 8, 4096*2 - 8 + 2048,
					4096*3 - 8 - 1, 4096*3 - 8 - 1 + 2048,
					4096*4 - 8*8*24, 4096*4 - 8*8*24 + 2048,
					4096*5 - 8*8*24 - 1, 4096*5 - 8*8*24 - 1 + 2048,
					4096*6 - 8*8*24 - 8, 4096*6 - 8*8*24 - 8 + 2048,
					4096*7 - 8*8*24 - 8 - 1, 4096*7 - 8*8*24 - 8 - 1 + 2048},
				{0, -4096},
				{0, -8192},
				{0, -16384},
			}
			...
			// 	{6},
			// 	{0, 2048},                        //24
			// 	{2, 24, 64, 128, 256, 512, 1024}, //24*5 and 7+3
			// 	{3, 8, 4096 - 1, 4096*2 - 8, 4096*3 - 8 - 1, 4096*4 - 8*8*24, 4096*5 - 8*8*24 - 1, 4096*6 - 8*8*24 - 8, 4096*7 - 8*8*24 - 8 - 1},
			// 	{0, -4096},
			// 	{0, -8192},
			// 	{0, -16384},
			// }
			...
			3 0.828860457
			4 1.235514082 */
			blueprints = [][]int{ //x=0, optimal
				{7},
				{1, 4, 64, 128},        //24*2
				{0, 2048},              //6
				{2, 6, 256, 512, 1024}, //6*3
				{3, 8, 4096 - 1, 4096*2 - 8, 4096*3 - 8 - 1, 4096*4 - 8*8*24, 4096*5 - 8*8*24 - 1, 4096*6 - 8*8*24 - 8, 4096*7 - 8*8*24 - 8 - 1},
				{0, -4096},
				{0, -8192},
				{0, -16384},
			...
			*/
			...
			// 	{1, 4, 64, 128},
			// 	{2, 6, 256, 512, 1024},
			// 	{3, 16, 2048, 4096 - 1, 4096 - 1 + 2048, 4096*2 - 8, 4096*2 - 8 + 2048, 4096*3 - 8 - 1, 4096*3 - 8 - 1 + 2048, 4096*4 - 8*8*24, 4096*4 - 8*8*24 + 2048, 4096*5 - 8*8*24 - 1, 4096*5 - 8*8*24 - 1 + 2048, 4096*6 - 8*8*24 - 8, 4096*6 - 8*8*24 - 8 + 2048, 4096*7 - 8*8*24 - 8 - 1, 4096*7 - 8*8*24 - 8 - 1 + 2048},
			// 	{0, -4096},
			// 	{0, -8192},
			// 	{0, -16384},
			// }
	...
	} else if convID == "CvTConv2" { //4*4*192 -> 2*2*384, kernel=3*3, k=1
		//CvTConv2
		//=================Choose MAP=================//
		if depth == 2 {
			/*rot num:  331
			2 3.010724672
			3 3.282832208 */
			blueprints = [][]int{ //x=2, optimal
				{6},
				{2, 48, 1, 8, 64, 128, 256, 512},
				{3, 32, 1024,
					2048, 2048 + 1024,
					4096 - 2, 4096 - 2 + 1024,
					4096 - 2 + 2048, 4096 - 2 + 2048 + 1024,
					4096*2 - 16, 4096*2 - 16 + 1024,
					4096*2 - 16 + 2048, 4096*2 - 16 + 2048 + 1024,
					4096*3 - 16 - 2, 4096*3 - 16 - 2 + 1024,
					4096*3 - 16 - 2 + 2048, 4096*3 - 16 - 2 + 2048 + 1024,
					4096*4 - 4*4*48, 4096*4 - 4*4*48 + 1024,
					4096*4 - 4*4*48 + 2048, 4096*4 - 4*4*48 + 2048 + 1024,
					4096*5 - 4*4*48 - 2, 4096*5 - 4*4*48 - 2 + 1024,
					4096*5 - 4*4*48 - 2 + 2048, 4096*5 - 4*4*48 - 2 + 2048 + 1024,
					4096*6 - 4*4*48 - 16, 4096*6 - 4*4*48 - 16 + 1024,
					4096*6 - 4*4*48 - 16 + 2048, 4096*6 - 4*4*48 - 16 + 2048 + 1024,
					4096*7 - 4*4*48 - 16 - 2, 4096*7 - 4*4*48 - 16 - 2 + 1024,
					4096*7 - 4*4*48 - 16 - 2 + 2048, 4096*7 - 4*4*48 - 16 - 2 + 2048 + 1024,
				},
				{0, -2048},
				{0, -4096},
				{0, -8192},
			...
			// 	{3, 16, 2048,
			// 		4096 - 2, 4096 - 2 + 2048,
			// 		4096*2 - 16, 4096*2 - 16 + 2048,
			// 		4096*3 - 16 - 2, 4096*3 - 16 - 2 + 2048,
			// 		4096*4 - 4*4*48, 4096*4 - 4*4*48 + 2048,
			// 		4096*5 - 4*4*48 - 2, 4096*5 - 4*4*48 - 2 + 2048,
			// 		4096*6 - 4*4*48 - 16, 4096*6 - 4*4*48 - 16 + 2048,
			// 		4096*7 - 4*4*48 - 16 - 2, 4096*7 - 4*4*48 - 16 - 2 + 2048,
			// 	},
			// 	{0, -2048},
			// 	{0, -4096},
			// 	{0, -8192},
	...
	} else if convID == "MuseConv" { //8*8*512 -> 8*8*512, kernel=3*3, k=1 //param set to PN15QP880CI
		//MuseConv
		//=================Choose MAP=================//
		if depth == 2 {
			/*rot num:  4616
...
func GetRotOptConvFeature(convID string) *ConvFeature {
	...
	if convID == "CONV1" { //32*32*3 -> 32*32*16, kernel=3*3, k=1
	...
	} else if convID == "CvTConv1" { //8*8*64 -> 4*4*192, kernel=3*3
		result.ConvID = "CvTConv1"
	...
	} else if convID == "CvTConv2" { //4*4*192 -> 2*2*384, kernel=3*3
		result.ConvID = "CvTConv2"
		...
		result.KernelBP = [][]int{
			{0, 2, 8, 10, 192, 194, 200, 202},
			{1, 3, 9, 11, 193, 195, 201, 203},
			{4, 6, 12, 14, 196, 198, 204, 206},
			{5, 7, 13, 15, 197, 199, 205, 207},
			{16, 18, 24, 26, 208, 210, 216, 218},
			{17, 19, 25, 27, 209, 211, 217, 219},
			{20, 22, 28, 30, 212, 214, 220, 222},
			{21, 23, 29, 31, 213, 215, 221, 223},
			{32, 34, 40, 42, 224, 226, 232, 234},
			{33, 35, 41, 43, 225, 227, 233, 235},
			{36, 38, 44, 46, 228, 230, 236, 238},
			{37, 39, 45, 47, 229, 231, 237, 239},
			{48, 50, 56, 58, 240, 242, 248, 250},
			{49, 51, 57, 59, 241, 243, 249, 251},
			{52, 54, 60, 62, 244, 246, 252, 254},
			{53, 55, 61, 63, 245, 247, 253, 255},
			{64, 66, 72, 74, 256, 258, 264, 266},
			{65, 67, 73, 75, 257, 259, 265, 267},
			{68, 70, 76, 78, 260, 262, 268, 270},
			{69, 71, 77, 79, 261, 263, 269, 271},
			{80, 82, 88, 90, 272, 274, 280, 282},
			{81, 83, 89, 91, 273, 275, 281, 283},
			{84, 86, 92, 94, 276, 278, 284, 286},
			{85, 87, 93, 95, 277, 279, 285, 287},
			{96, 98, 104, 106, 288, 290, 296, 298},
			{97, 99, 105, 107, 289, 291, 297, 299},
			{100, 102, 108, 110, 292, 294, 300, 302},
			{101, 103, 109, 111, 293, 295, 301, 303},
			{112, 114, 120, 122, 304, 306, 312, 314},
			{113, 115, 121, 123, 305, 307, 313, 315},
			{116, 118, 124, 126, 308, 310, 316, 318},
			{117, 119, 125, 127, 309, 311, 317, 319},
			{128, 130, 136, 138, 320, 322, 328, 330},
			{129, 131, 137, 139, 321, 323, 329, 331},
			{132, 134, 140, 142, 324, 326, 332, 334},
			{133, 135, 141, 143, 325, 327, 333, 335},
			{144, 146, 152, 154, 336, 338, 344, 346},
			{145, 147, 153, 155, 337, 339, 345, 347},
			{148, 150, 156, 158, 340, 342, 348, 350},
			{149, 151, 157, 159, 341, 343, 349, 351},
			{160, 162, 168, 170, 352, 354, 360, 362},
			{161, 163, 169, 171, 353, 355, 361, 363},
			{164, 166, 172, 174, 356, 358, 364, 366},
			{165, 167, 173, 175, 357, 359, 365, 367},
			{176, 178, 184, 186, 368, 370, 376, 378},
			{177, 179, 185, 187, 369, 371, 377, 379},
			{180, 182, 188, 190, 372, 374, 380, 382},
			{181, 183, 189, 191, 373, 375, 381, 383},
		}

		result.q = 48

	} else if convID == "MuseConv" { //7*7*512 -> 7*7*512, kernel=3*3,
		result.ConvID = "MuseConv"
